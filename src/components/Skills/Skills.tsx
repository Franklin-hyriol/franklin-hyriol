      ...
      <div className="main-container">
        ...
        <div className="mb-20 flex flex-col items-center">
          ...
          <ul className="list-disc">
            ...
            <li>
              <strong>Gestion du stress :</strong> reste calme et productif en
              toutes circonstances
            </li>
            <li>
              <strong>Autonomie & Curiosité :</strong> capable de prendre des
              initiatives et d’apprendre par moi-même
            </li>
            <li>
              <strong>Passion & Engagement :</strong> motivé et impliqué dans
              tout projet que j’entreprends
            </li>
            <li>
              <strong>Langues :</strong> français courant, anglais compris (en
              progression pour discussions approfondies)
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="overflow-x-auto rounded-box border border-base-content/5 bg-base-100 w-[80%] mx-auto">
                ...
                <tr>
                  ...
                  <td>
                    <ul className="list-disc">
                      ...
                      <li>
                        Sites{" "}
                        <strong>responsive & composants réutilisables</strong>
                      </li>
                      <li>
                        Intégration WordPress (<strong>ACF, Elementor</strong>),{" "}
                        <strong>Prestashop</strong>, <strong>Symfony</strong>,{" "}
