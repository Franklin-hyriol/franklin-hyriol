      ...
      <div className="w-[80%] mx-auto flex flex-col gap-20">
        ...
        <ScrollReveal>
          <Projetctech
            text={
              <>
                Cette application a été développée en pur{" "}
                <strong>HTML</strong>, <strong>Tailwind CSS</strong> et{" "}
                <strong>TypeScript</strong>, car je voulais une application
                légère, rapide et agréable à coder.
              </>
            }
          />
        </ScrollReveal>
